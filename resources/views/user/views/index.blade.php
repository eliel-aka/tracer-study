                                ...
                                <div class="pb-3 border-b border-[#f1f1f1] dark:border-dark-3">
                                    ...
                                    <div class="edit-mode hidden">
                                        <input type="text" name="jabatan" 
                                            value="@if($user->hasRole('lulusan') && $user->lulusan){{ $user->lulusan->jabatan }}@elseif($user->hasRole('penggunaLulusan') && $user->penggunaLulusan){{ $user->penggunaLulusan->jabatan }}@endif"
                                ...
                                <div class="pb-3 border-b border-[#f1f1f1] dark:border-dark-3">
                                    ...
                                    <div class="edit-mode hidden">
                                        <input type="text" name="satuan_kerja" 
                                            value="@if($user->hasRole('lulusan') && $user->lulusan){{ $user->lulusan->satuan_kerja }}@elseif($user->hasRole('penggunaLulusan') && $user->penggunaLulusan){{ $user->penggunaLulusan->satuan_kerja }}@endif"
                                            class="w-full px-3 py-2 text-sm border-2 border-gray-300 dark:border-gray-500 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 transition-colors"
                                ...
                                <div class="pb-3 border-b border-[#f1f1f1] dark:border-dark-3">
                                    ...
                                    <div class="edit-mode hidden">
                                        <input type="text" name="unit_kerja" 
                                            value="@if($user->hasRole('lulusan') && $user->lulusan){{ $user->lulusan->unit_kerja }}@elseif($user->hasRole('penggunaLulusan') && $user->penggunaLulusan){{ $user->penggunaLulusan->unit_kerja }}@endif"
                                            class="w-full px-3 py-2 text-sm border-2 border-gray-300 dark:border-gray-500 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-400 dark:focus:border-blue-400 transition-colors"
