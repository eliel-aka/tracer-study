            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
              ...
              <form method="POST" action="{{ route('logout') }}">
                  ...
                  <li class="flex items-center">
                    <a :href="route('logout')" onclick="event.preventDefault();this.closest('form').submit();"class="block px-0 py-2 text-sm font-semibold text-white transition-all ease-nav-brand cursor-pointer">
