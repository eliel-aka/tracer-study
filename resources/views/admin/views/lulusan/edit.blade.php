...
@section('title', 'Edit Lulusan')

@section('content')

<!-- table 1 -->
<form action="{{ route('admin.lulusan.update',$lulusan) }}" method="POST">
    @csrf
    @method('PUT')
                    ...
                    <div class="flex-auto p-6">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="nama" value="{{ $lulusan->nama }}"
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="nip_baru" value="{{ old('nip_baru', $lulusan->nip_baru ?? $lulusan->nip) }}" placeholder="Contoh: 199801012022011001" maxlength="18"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('nip_baru')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="nip_lama" value="{{ old('nip_lama', $lulusan->nip_lama) }}" placeholder="Contoh: 123456789" maxlength="9"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('nip_lama')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="email" name="email" value="{{ $lulusan->user->email }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('email')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <select name="prodi"
                                    ...
                                    <option value="D-IV Komputasi Statistik" {{ old('prodi', $lulusan->prodi) == 'D-IV Komputasi Statistik' ? 'selected' : '' }}>
                                        D-IV Komputasi Statistik
                                    </option>
                                    <option value="D-IV Statistika" {{ old('prodi', $lulusan->prodi) == 'D-IV Statistika' ? 'selected' : '' }}>
                                        D-IV Statistika
                                    </option>
                                    <option value="D-III Statistika" {{ old('prodi', $lulusan->prodi) == 'D-III Statistika' ? 'selected' : '' }}>
                                        D-III Statistika
                                    </option>
                                </select>
                                @error('prodi')
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <select name="jabatan" id="jabatan" class="searchable-select w-full">
                                    ...
                                    @foreach($masterJabatan as $j)
                                        <option value="{{ $j->nama }}" {{ old('jabatan', $lulusan->jabatan) == $j->nama ? 'selected' : '' }}>{{ $j->nama }}</option>
                                    @endforeach
                                </select>
                                @error('jabatan')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <select name="satuan_kerja" id="satuan_kerja" class="searchable-select w-full">
                                    ...
                                    @foreach($masterSatuanKerja as $sk)
                                        <option value="{{ $sk->nama }}" {{ old('satuan_kerja', $lulusan->satuan_kerja) == $sk->nama ? 'selected' : '' }}>{{ $sk->nama }}</option>
                                    @endforeach
                                </select>
                                @error('satuan_kerja')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <select name="unit_kerja" id="unit_kerja" class="searchable-select w-full">
                                    ...
                                    @foreach($masterUnitKerja as $uk)
                                        <option value="{{ $uk->nama }}" {{ old('unit_kerja', $lulusan->unit_kerja) == $uk->nama ? 'selected' : '' }}>{{ $uk->nama }}</option>
                                    @endforeach
                                </select>
                                @error('unit_kerja')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                            ...
                            <!-- Provinsi -->
                            <div class="w-full px-3 mb-4">
                                <label for="provinsi" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">
                                    Provinsi <span class="text-red-500">*</span>
                                </label>
                                <input type="text" name="provinsi" value="{{ old('provinsi', $lulusan->provinsi) }}" required
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('provinsi')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <!-- Kabupaten -->
                            <div class="w-full px-3 mb-4">
                                <label for="kabupaten" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">
                                    Kabupaten/Kota <span class="text-red-500">*</span>
                                </label>
                                <input type="text" name="kabupaten" value="{{ old('kabupaten', $lulusan->kabupaten) }}" required
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('kabupaten')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="no_hp" value="{{ $lulusan->no_hp }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('no_hp')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="tanggal_lahir" value="{{ $lulusan->tanggal_lahir }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('tanggal_lahir')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="tahun_lulus" value="{{ $lulusan->tahun_lulus }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('tahun_lulus')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="nip_baru_pengguna_lulusan" value="{{ old('nip_baru_pengguna_lulusan', $lulusan->nip_baru_pengguna_lulusan ?? $lulusan->nip_pengguna_lulusan) }}" placeholder="Contoh: 198001012005011001" maxlength="18"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="nip_lama_pengguna_lulusan" value="{{ old('nip_lama_pengguna_lulusan', $lulusan->nip_lama_pengguna_lulusan) }}" placeholder="Contoh: 123456789" maxlength="9"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
