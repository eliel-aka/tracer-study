                ...
                <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="flex-auto p-6">
                        ...
                        <div class="flex flex-wrap -mx-3">
                            ...
                            <!-- NIP -->
                            <div class="w-full px-3 mb-4">
                                <label for="nip" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">
                                    NIP <span class="text-red-500">*</span>
                                </label>
                                <input type="text" name="nip" value="{{ $lulusan->nip }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('nip')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="jabatan" value="{{ $lulusan->jabatan }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('jabatan')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="satuan_kerja" value="{{ $lulusan->satuan_kerja }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('satuan_kerja')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="w-full px-3 mb-4">
                                ...
                                <input type="text" name="unit_kerja" value="{{ $lulusan->unit_kerja }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('unit_kerja')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            ...
                            <!-- NIP Pengguna -->
                            <div class="w-full px-3 mb-4">
                                <label for="nip_pengguna_lulusan" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">
                                    NIP Pengguna Lulusan <span class="text-red-500">*</span>
                                </label>
                                <input type="text" name="nip_pengguna_lulusan" value="{{ $lulusan->nip_pengguna_lulusan }}"
                                    class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                                @error('nip_pengguna_lulusan')
                                    <span class="text-red-500 text-xs">{{ $message }}</span>
                                @enderror
                            </div>
