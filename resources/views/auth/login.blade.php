...
<body class="bg-[#F4F7FF] dark:bg-dark">
  ...
  <!-- ====== Forms Section Start -->
  <section class="h-screen bg-[#F4F7FF] w-full dark:bg-dark flex items-center justify-center pt-20">
    <div class="w-full max-w-[525px] mx-auto px-4">
      <div
        class="wow fadeInUp relative overflow-hidden rounded-lg bg-white dark:bg-dark-2 py-14 px-8 text-center sm:px-12 md:px-[60px] shadow-xl"
        data-wow-delay=".15s">
            <div class="mb-10 text-center">
              <a href="javascript:void(0)" class="mx-auto inline-block max-w-[160px]">
                <img src="{{asset('assets/images/logo/ts.svg')}}" alt="logo" class="dark:hidden" />
                <img src="{{asset('assets/images/logo/ts_white.svg')}}" alt="logo" class="hidden dark:block" />
              </a>
            </div>
