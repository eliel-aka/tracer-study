...
class FormBuilderController extends Controller
{
    ...
    private function validateQuestionsOnlyData(Request $request)
    {
        $rules = [
            ...
            'sections.*.section_description' => 'nullable|string|max:5000',
            'sections.*.questions' => 'nullable|array|max:50',
            'sections.*.questions.*.question' => 'required|string|max:2000',
            ...
            'sections.*.kompetensi_config.pertanyaan_utama' => 'nullable|string|max:2000',
